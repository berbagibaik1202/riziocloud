...
async function render(){
 ...
 document.querySelector<HTMLButtonElement>('#logout')!.onclick=async()=>{try{await api('/auth/logout','POST',{refresh_token:refresh});}catch{}access='';refresh='';login();};
