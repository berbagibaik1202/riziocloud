...
const schema = z.object({
 ...
 MQTT_URL:z.string().url().refine(v=>v.startsWith('mqtts://'),'MQTT TLS is required'), MQTT_USERNAME:z.string().min(1), MQTT_PASSWORD:z.string().min(16), MQTT_CA_PATH:z.string().optional(),
